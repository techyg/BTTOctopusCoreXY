This repository contains the printer.cfg file that I use with my BTT Octopus board, which is for a Core XY printer (originally based on a Hypercube Evolution):
